...
p_load(dplyr, tidyverse, ggplot2, gtsummary, Hmisc, haven, 
       survey, svrepmisc, car, lme4, lmtest, gamm4, mgcv, multcomp)
...
##################################################################
#Summarize descriptive statistics for the entire ABCD sample in year 2 (N = 10,973)
...
# 1. MICE for multiple imputation (analysis conducted in SAS)

# 2. Calculation of the E-value (conducted on: https://www.evalue-calculator.com/evalue/)

# 3. Additionally adjusted for sleep duration, trouble falling or staying asleep, depressive and anxiety symptoms
# Pain incidence 
...
# 4. Pain intensity and body regions analyzed as continuous outcomes
...
# 5. In adolescents with pain at baseline, examine chronotype in relation to pain prognosis 
